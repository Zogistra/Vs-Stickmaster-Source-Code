...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgScroll:FlxBackdrop = new FlxBackdrop(Paths.image('cube'), 5, 5, true, true, -33, -32);
		...
		FlxG.camera.follow(camFollowPos, null, 1);
			...
			char1 = new Character(620, -20, 'stickmaster', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(565, 100, 'luke', true);
		char2.setGraphicSize(Std.int(char2.width * 0.8));
		add(char2);
		char2.visible = false;

		char3 = new Character(515, 290, 'stickmasterfase2', true);
		char3.setGraphicSize(Std.int(char3.width * 0.8));
		add(char3);
		char3.visible = false;

		char4 = new Character(620, 180, 'blaze-happy', true);
