...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
        ...
        logoBl.frames = Paths.getSparrowAtlas('sticklog');
	...
	StickSpr = new FlxSprite(550, 0);
        StickSpr.frames = Paths.getSparrowAtlas('stickmaster_title_screen');
        StickSpr.antialiasing = ClientPrefs.globalAntialiasing;
        StickSpr.animation.addByPrefix('dance', 'GF Dancing Beat', 24);
        StickSpr.animation.play('dance');
        StickSpr.updateHitbox();
        add(StickSpr);
...

	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('Finally, after a damn year');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Friday Night Funkin');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Vs Stickmaster'); // credTextShit.text += '\nFunkin';
